...
CREATE TYPE adjustment_reason AS ENUM ('count_correction', 'damaged', 'expired', 'purchase', 'sale_deduction', 'theft', 'transfer_in', 'transfer_out', 'void_return', 'waste');
CREATE TYPE adjustment_type AS ENUM ('physical_count', 'sale', 'stock_in', 'stock_out', 'transfer', 'void_return');
CREATE TYPE customer_tier AS ENUM ('regular', 'vip_gold', 'vip_platinum', 'vip_silver');
CREATE TYPE discount_type AS ENUM ('complimentary', 'fixed_amount', 'percentage');
CREATE TYPE event_type AS ENUM ('anniversary', 'birthday', 'custom');
CREATE TYPE kitchen_order_status AS ENUM ('cancelled', 'pending', 'preparing', 'ready', 'served');
CREATE TYPE notification_priority AS ENUM ('high', 'low', 'normal', 'urgent');
CREATE TYPE notification_type AS ENUM ('beverage_delivered', 'beverage_ready', 'food_delivered', 'food_ready', 'low_stock', 'order_completed', 'order_created', 'order_voided', 'out_of_stock', 'reorder_point', 'system_alert');
CREATE TYPE order_destination AS ENUM ('bartender', 'both', 'kitchen');
CREATE TYPE order_status AS ENUM ('completed', 'confirmed', 'draft', 'on_hold', 'pending', 'preparing', 'ready', 'served', 'voided');
CREATE TYPE package_type AS ENUM ('promotional', 'regular', 'vip_only');
CREATE TYPE payment_method AS ENUM ('bank_transfer', 'card', 'cash', 'gcash', 'paymaya', 'split');
CREATE TYPE product_type AS ENUM ('complex', 'simple');
CREATE TYPE session_status AS ENUM ('abandoned', 'closed', 'open');
CREATE TYPE table_status AS ENUM ('available', 'cleaning', 'occupied', 'reserved');
CREATE TYPE user_role AS ENUM ('admin', 'bartender', 'cashier', 'kitchen', 'manager', 'waiter');
...
CREATE INDEX idx_users_manager_pin ON users(manager_pin) WHERE manager_pin IS NOT NULL;
...
CREATE TABLE notifications (
    ...
    CONSTRAINT check_targeting CHECK (user_id IS NOT NULL OR role IS NOT NULL)
);
